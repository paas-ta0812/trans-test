# PaaS\_TA\_3.5\_migration

### Table of Contents

1. [개요](paas_ta_3.5_migration.md#1)
   * [목적](paas_ta_3.5_migration.md#2)
   * [범위](paas_ta_3.5_migration.md#3)
2. [Paasta 3.5 version upgrade](paas_ta_3.5_migration.md#4)
   * [pre-requsite](paas_ta_3.5_migration.md#5)
   * [paasta-3.1 backup](paas_ta_3.5_migration.md#6)
   * [ccdb, uaadb backup \(bosh cli 1 기준\)](paas_ta_3.5_migration.md#7)
   * [blobstore backup](paas_ta_3.5_migration.md#8)
   * [ccdb, uaadb datafile edit](paas_ta_3.5_migration.md#9)
   * [paasta-3.5 restore](paas_ta_3.5_migration.md#10)
   * [pre-requisite](paas_ta_3.5_migration.md#11)
   * [blob-store recovery](paas_ta_3.5_migration.md#12)
   * [uaa database recovery](paas_ta_3.5_migration.md#13)
   * [cloud\_controller database recovery](paas_ta_3.5_migration.md#14)
   * [사용자 및 App 확인 ](paas_ta_3.5_migration.md#15)
...
![](../../../.gitbook/assets/paasta-migration%20%282%29.png)
...
* Paasta-controller.yml에 db\_encryption\_key에 있는 값이 paasta-3.5 설치시 동일해야 한다.
