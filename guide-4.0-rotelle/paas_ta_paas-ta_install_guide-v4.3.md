# PaaS\_TA\_PaaS-TA\_Install\_Guide-v4.3

### Table of Contents

1. [개요](paas_ta_paas-ta_install_guide-v4.3.md#1)
   * [목적](paas_ta_paas-ta_install_guide-v4.3.md#2)
   * [범위](paas_ta_paas-ta_install_guide-v4.3.md#3)
   * [참고자료](paas_ta_paas-ta_install_guide-v4.3.md#4)
2. [paasta-4.3](paas_ta_paas-ta_install_guide-v4.3.md#5)
   * [paasta-3.1](paas_ta_paas-ta_install_guide-v4.3.md#6)
   * [paasta-4.3](paas_ta_paas-ta_install_guide-v4.3.md#7)
3. [paasta-4.3 설치](paas_ta_paas-ta_install_guide-v4.3.md#8)
   * [pre-requsite](paas_ta_paas-ta_install_guide-v4.3.md#9)
   * [Stemcell upload](paas_ta_paas-ta_install_guide-v4.3.md#10)
   * [cloud-config](paas_ta_paas-ta_install_guide-v4.3.md#11)
     * [azs](paas_ta_paas-ta_install_guide-v4.3.md#12)
     * [vm\_types](paas_ta_paas-ta_install_guide-v4.3.md#13)
     * [compilation](paas_ta_paas-ta_install_guide-v4.3.md#14)
     * [disk\_size](paas_ta_paas-ta_install_guide-v4.3.md#15)
     * [networks](paas_ta_paas-ta_install_guide-v4.3.md#16)
   * [bosh-dns release upload](paas_ta_paas-ta_install_guide-v4.3.md#17)
     * [update-runtime-config.sh](paas_ta_paas-ta_install_guide-v4.3.md#18)
   * [paasta설치 파일](paas_ta_paas-ta_install_guide-v4.3.md#19)
   * [paasta deploy shell](paas_ta_paas-ta_install_guide-v4.3.md#20)
     * [deploy-aws.sh](paas_ta_paas-ta_install_guide-v4.3.md#21)
     * [deploy-openstack.sh](paas_ta_paas-ta_install_guide-v4.3.md#22)
     * [deploy-azure.sh](paas_ta_paas-ta_install_guide-v4.3.md#23)
     * [deploy-google.sh](paas_ta_paas-ta_install_guide-v4.3.md#24)
     * [deploy-vsphere.sh](paas_ta_paas-ta_install_guide-v4.3.md#25)
     * [deploy-bosh-lite.sh](paas_ta_paas-ta_install_guide-v4.3.md#26)
     * [operation file](paas_ta_paas-ta_install_guide-v4.3.md#27)
     * [PaaS-TA value](paas_ta_paas-ta_install_guide-v4.3.md#28)
   * [paasta deploy](paas_ta_paas-ta_install_guide-v4.3.md#29)
   * [paasta deploy 확인](paas_ta_paas-ta_install_guide-v4.3.md#30)
   * [paasta login](paas_ta_paas-ta_install_guide-v4.3.md#31)
...
본문서는 cf-deployment v6.10.0을 기준으로 작성 되었다. 기본 stemcell은 기존 ubuntu-xenial-97.28에서 ubuntu-xenial-170.16 변경되었다.
...
Paasta-4.3는 ubuntu xenial stemcell 170.16을 기반으로 한다. Bosh login 후 stemcell을 upload 한다. Stemcell은 Deploy될 때 생성되는 PaaS-TA VM Base OS Image이다. Bosh Login 후 다음 명령어를 수행하여 stemcel을 upload 한다. stemcell은 bosh 설치시 download 받아야 한다. director\_name은 bosh를 설치할때 사용한 director\_name을 입력한다.
...
~/workspace/paasta-4.3/deployment/paasta-deployment 이하 디렉토리에는 iaas별 paasta를 설치하는 shell이 존재한다. Shell 파일을 이용하여 bosh를 설치 한다. 파일명은 deploy-{iaaS-name}.sh 로 만들어 졌다.
...
![](../.gitbook/assets/uaac-cli%20%284%29.png)
...
![](../.gitbook/assets/paasta-vms%20%288%29.png)
...
![](../.gitbook/assets/paasta-login%20%287%29.png)
