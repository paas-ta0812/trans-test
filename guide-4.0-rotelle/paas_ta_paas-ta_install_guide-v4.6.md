# PaaS\_TA\_PaaS-TA\_Install\_Guide-v4.6

### Table of Contents

1. [개요](paas_ta_paas-ta_install_guide-v4.6.md#101)
   * [목적](paas_ta_paas-ta_install_guide-v4.6.md#102)
   * [범위](paas_ta_paas-ta_install_guide-v4.6.md#103)
   * [참고 자료](paas_ta_paas-ta_install_guide-v4.6.md#104)
2. [PaaS-TA 4.6](paas_ta_paas-ta_install_guide-v4.6.md#105)
   * [PaaS-TA 3.1](paas_ta_paas-ta_install_guide-v4.6.md#106)
   * [PaaS-TA 4.6](paas_ta_paas-ta_install_guide-v4.6.md#107)
3. [PaaS-TA 4.6 설치](paas_ta_paas-ta_install_guide-v4.6.md#108)
   * [Pre-requisite](paas_ta_paas-ta_install_guide-v4.6.md#109)
   * [PaaS-TA release 파일 다운로드](paas_ta_paas-ta_install_guide-v4.6.md#1010)
   * [Stemcell 업로드](paas_ta_paas-ta_install_guide-v4.6.md#1011)
   * [Cloud Config 설정](paas_ta_paas-ta_install_guide-v4.6.md#1012)
     * [azs](paas_ta_paas-ta_install_guide-v4.6.md#1013)
     * [vm types](paas_ta_paas-ta_install_guide-v4.6.md#1014)
     * [compilation](paas_ta_paas-ta_install_guide-v4.6.md#1015)
     * [disk size](paas_ta_paas-ta_install_guide-v4.6.md#1016)
     * [networks](paas_ta_paas-ta_install_guide-v4.6.md#1017)
   * [bosh-dns release 업로드](paas_ta_paas-ta_install_guide-v4.6.md#1018)
     * [update-runtime-config.sh 설정](paas_ta_paas-ta_install_guide-v4.6.md#1019)
   * [PaaS-TA 설치 파일](paas_ta_paas-ta_install_guide-v4.6.md#1020)
   * [PaaS-TA Deploy Shell Scripts](paas_ta_paas-ta_install_guide-v4.6.md#1021)
     * [deploy-aws.sh](paas_ta_paas-ta_install_guide-v4.6.md#1022)
     * [deploy-openstack.sh](paas_ta_paas-ta_install_guide-v4.6.md#1023)
     * [deploy-azure.sh](paas_ta_paas-ta_install_guide-v4.6.md#1024)
     * [deploy-gcp.sh](paas_ta_paas-ta_install_guide-v4.6.md#1025)
     * [deploy-vsphere.sh](paas_ta_paas-ta_install_guide-v4.6.md#1026)
     * [deploy-bosh-lite.sh](paas_ta_paas-ta_install_guide-v4.6.md#1027)
     * [PaaS-TA Operation 파일](paas_ta_paas-ta_install_guide-v4.6.md#1028)
     * [PaaS-TA Variable List](paas_ta_paas-ta_install_guide-v4.6.md#1029)
   * [PaaS-TA Deploy](paas_ta_paas-ta_install_guide-v4.6.md#1030)
   * [PaaS-TA Deploy 확인](paas_ta_paas-ta_install_guide-v4.6.md#1031)
   * [PaaS-TA Login](paas_ta_paas-ta_install_guide-v4.6.md#1032)
...
본 문서는 cf-deployment v9.3.0을 기준으로 작성되었다. PaaS-TA 4.6을 설치 시 필요한 Stemcell은 기존 ubuntu-xenial-250.21에서 ubuntu-xenial-315.36으로 변경되었다.
...
![](../.gitbook/assets/bosh1%20%2810%29.png)
...
![](../.gitbook/assets/bosh2%20%2810%29.png)
...
PaaS-TA 4.6는 ubuntu xenial stemcell 315.36을 기반으로 한다. Stemcell은 Deploy 될 때 생성되는 PaaS-TA VM Base OS Image이다. BOSH Login 후 다음 명령어를 수행하여 Stemcell을 업로드한다. Stemcell은 파스타 다운로드 URL에서 \[PaaS-TA 스템셀 이미지\] 파일을 다운로드한다. {director\_name}은 BOSH 설치 시 사용한 Director Name을 입력한다.
...
PaaS-TA 4.6을 설치하기 위한 IaaS 관련 network, storage, vm 관련 설정들을 정의한다. IaaS, network, disk 등 상황에 따라 설정이 다르다. paasta-deployment.yml은 cloud-config 설정에 따라 PaaS-TA VM을 설치한다. PaaS-TA Deploy 전에 Cloud Config를 BOSH에 설정한다. IaaS 별 Cloud Config 예제를 참고하여 cloud-config.yml을 IaaS 상황에 맞게 적용한다. PaaS-TA 4.6 deployment를 다운로드하면 cloud-config 디렉터리 이하에 IaaS 별 cloud-config 예제를 확인할 수 있다.
...
다음은 OpenStack에서 정의한 Flavor Type이다. ![](../.gitbook/assets/flavor%20%285%29.png)
...
networks는 az zone 별 subnet network, dns, security groups, network id를 정의한다. 보통 azs 별로 256개의 IP를 정의할 수 있도록 range cider를 정의한다.

### 3.5.  bosh-dns release 업로드
...
#### 3.5.1. update-runtime-config.sh 설정
...
| deploy-aws.sh | AWS PaaS-TA 설치 Shell |
| :--- | :--- |
| deploy-openstack.sh | OpenStack PaaS-TA 설치 Shell |
| deploy-vsphere.sh | vSphere PaaS-TA 설치 Shell |
| deploy-gcp.sh | GCP\(google\) PaaS-TA 설치 Shell |
| deploy-azure.sh | Azure PaaS-TA 설치 Shell |
| deploy-bosh-lite.sh | Bosh-lite\(local Test용\) PaaS-TA 설치 Shell |
...
※ deploy 명령어 예시 \(paasta deploy는 [3.7 PaaS-TA Deploy Shell Scripts](paas_ta_paas-ta_install_guide-v4.6.md#1021) 참조\)
...
다음은 PaaS-TA Deploy 시 필수 옵션이며, cf\_admin\_password, cc\_db\_encryption\_key, uaa\_database\_password, cc\_database\_password는 –v 옵션이 없는 경우 BOSH에서 자동 생성하여 BOSH CredHub에 저장한다.
...
#### 3.7.7. PaaS-TA Operation 파일

| 파일명 | 설명 | 요구사항 |
| :--- | :--- | :--- |
| operations/use-compiled-releases.yml | PaaS-TA release에서 제공하는 파일로 다운로드 및 컴파일 없이 빠른 설치가 가능하다. |  |
| operations/use-postgres.yml | Database를 postgres로 설치  - use-postgres.yml 미적용 시 MySQL 설치  - 3.5 이전 버전에서 migration 시 필수 |  |
| operations/use-haproxy.yml | Haproxy 적용  - IaaS에서 제공하는 LB를 사용하여 PaaS-TA 설치 시, Operation 파일을 제거하고 설치한다. | Requires operation file: use-haproxy-public-network.ym  Requires value : -v haproxy\_private\_ip |
| operations/use-haproxy-public-network.yml | Haproxy Public Network 설정  - IaaS에서 제공하는 LB를 사용하여 PaaS-TA 설치 시, Operation 파일을 제거하고 설치한다. | Requires: use-haproxy.yml  Requires value :  -v haproxy\_public\_ip  -v haproxy\_public\_network\_name |
| paasta-addon/paasta-monitoring.yml | PaaS-TA Monitoring Agent 적용  - PaaS-TA Monitoring 적용 시 필수 | Requires value :  -v metric\_url |
...
2. uaa\_login\_links\_passwd : uaa 페이지에서 Reset password 버튼 클릭 시 이동하는 링크 주소 ![](../.gitbook/assets/uaa-login%20%282%29.png)
3. uaa\_login\_links\_signup : uaa 페이지에서 Create account 버튼 클릭 시 이동하는 링크 주소 ![](../.gitbook/assets/uaa-login-2%20%282%29.png)

   ```text
   ex) uaa_login_links_signup="{PaaS-TA PORTAL URI}/createuser"
   ```

4. uaa\_clients\_portalclient\_redirect\_uri : uaa portalclient의 redirect uri 지정 변수, 포탈에서 로그인 버튼 클릭 후 uaa 페이지에서 로그인 성공 시 이동하는 URI

   ```text
   ex) uaa_clients_portalclient_redirect_uri="{PaaS-TA PORTAL URI}, {PaaS-TA PORTAL URI}/callback"
   ```

5. uaa\_clients\_portalclinet\_secret : uaac portalclient에 접근하기 위한 secret 변수
...
6. uaa\_admin\_client\_secret : uaac adminclient에 접근하기 위한 secret 변수

   ```text
   ex) uaa_admin_client_secret="admin-secret"
   ```

7. uaa\_admin\_client\_secret 적용 확인 방법
...
CF CLI를 설치하고 PaaS-TA에 로그인한다. cf api target 은 PaaS-TA Deploy 시 지정해주었던 system\_domain 명을 사용한다.
