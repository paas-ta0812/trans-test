...
1. [문서 개요](paas-ta-pinpoint.md#1)
   * 1.1. [목적](paas-ta-pinpoint.md#11)
   * 1.2. [범위](paas-ta-pinpoint.md#12)
   * 1.3. [시스템 구성도](paas-ta-pinpoint.md#13)
   * 1.4. [참고자료](paas-ta-pinpoint.md#14)
2. [Pinpoint 서비스팩 설치](paas-ta-pinpoint.md#2)
   * 2.1. [설치전 준비사항](paas-ta-pinpoint.md#21)
   * 2.2. [Pinpoint 서비스 릴리즈 업로드](paas-ta-pinpoint.md#22)
   * 2.3. [Pinpoint 서비스 Deployment 파일 수정 및 배포](paas-ta-pinpoint.md#23)
   * 2.4. [Pinpoint 서비스 브로커 등록](paas-ta-pinpoint.md#24)
3. [Sample Web App 연동 Pinpoint 연동](paas-ta-pinpoint.md#3)
   * 3.1. [Sample Web App 구조](paas-ta-pinpoint.md#31)
   * 3.2. [PaaS-TA에서 서비스 신청](paas-ta-pinpoint.md#32)
   * 3.3. [Sample Web App에 서비스 바인드 신청 및 App 확인](paas-ta-pinpoint.md#33)
...
![](https://github.com/jhuhm13579/trans-test/tree/c3fa60c3f2804eba4cf4bb19f90449a85a66a625/Service-Guide/images/pinpoint/pinpoint-image1.png)
...
![](https://github.com/jhuhm13579/trans-test/tree/c3fa60c3f2804eba4cf4bb19f90449a85a66a625/Service-Guide/images/pinpoint/pinpoint-image3.png)
