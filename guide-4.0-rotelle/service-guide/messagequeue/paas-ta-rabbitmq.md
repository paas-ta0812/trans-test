...
1. [문서 개요](paas-ta-rabbitmq.md#1)
   * 1.1. [목적](paas-ta-rabbitmq.md#11)
   * 1.2. [범위](paas-ta-rabbitmq.md#12)
   * 1.3. [시스템 구성도](paas-ta-rabbitmq.md#13)
   * 1.4. [참고자료](paas-ta-rabbitmq.md#14)
2. [RabbitMQ 서비스팩 설치](paas-ta-rabbitmq.md#2)
   * 2.1. [설치전 준비사항](paas-ta-rabbitmq.md#21)
   * 2.2. [RabbitMQ 서비스 릴리즈 업로드](paas-ta-rabbitmq.md#22)
   * 2.3. [2.3. RabbitMQ 서비스 Deployment 파일 수정 및 배포](paas-ta-rabbitmq.md#23)
   * 2.4. [RabbitMQ 서비스 브로커 등록](paas-ta-rabbitmq.md#24)
3. [RabbitMQ 연동 Sample App 설명](paas-ta-rabbitmq.md#3)
   * 3.1. [PaaS-TA에서 서비스 신청](paas-ta-rabbitmq.md#31)
   * 3.2. [Sample App에 서비스 바인드 신청 및 App 확인](paas-ta-rabbitmq.md#32)
...
![](https://github.com/jhuhm13579/trans-test/tree/c3fa60c3f2804eba4cf4bb19f90449a85a66a625/Service-Guide/images/rabbitmq/rabbitmq_image_01.png)
...
> `$ cf service-brokers`
>
> ![](https://github.com/jhuhm13579/trans-test/tree/c3fa60c3f2804eba4cf4bb19f90449a85a66a625/Service-Guide/images/rabbitmq/rabbitmq_image_02.png)
...
>
> ![](https://github.com/jhuhm13579/trans-test/tree/c3fa60c3f2804eba4cf4bb19f90449a85a66a625/Service-Guide/images/rabbitmq/rabbitmq_image_03.png)

**등록된 RabbitMQ 서비스 브로커를 확인한다.**

> `$ cf service-brokers`
>
> ![](https://github.com/jhuhm13579/trans-test/tree/c3fa60c3f2804eba4cf4bb19f90449a85a66a625/Service-Guide/images/rabbitmq/rabbitmq_image_04.png)

#### 접근 가능한 서비스 목록을 확인한다.

> `$ cf service-access`
>
> ![](https://github.com/jhuhm13579/trans-test/tree/c3fa60c3f2804eba4cf4bb19f90449a85a66a625/Service-Guide/images/rabbitmq/rabbitmq_image_05.png)
...
> `$ cf marketplace`
>
> ![](https://github.com/jhuhm13579/trans-test/tree/c3fa60c3f2804eba4cf4bb19f90449a85a66a625/Service-Guide/images/rabbitmq/rabbitmq_image_08.png)
...
>
> ![](https://github.com/jhuhm13579/trans-test/tree/c3fa60c3f2804eba4cf4bb19f90449a85a66a625/Service-Guide/images/rabbitmq/rabbitmq_image_09.png)

#### 생성된 rabbitmq 서비스 인스턴스를 확인한다.

> `$ cf services`
>
> ![](https://github.com/jhuhm13579/trans-test/tree/c3fa60c3f2804eba4cf4bb19f90449a85a66a625/Service-Guide/images/rabbitmq/rabbitmq_image_10.png)
...
> `http://test-app.<YOUR_DOMAIN>/write` `http://test-app.<YOUR_DOMAIN>/read` ![](https://github.com/jhuhm13579/trans-test/tree/c3fa60c3f2804eba4cf4bb19f90449a85a66a625/Service-Guide/images/rabbitmq/rabbitmq_image_12.png)

#### 스토어 엔드포인트 테스트

> `curl -XPOST -d 'test' http://test-app.<YOUR-DOMAIN>/store` `curl -XGET http://test-app.<YOUR-DOMAIN>/store` ![](https://github.com/jhuhm13579/trans-test/tree/c3fa60c3f2804eba4cf4bb19f90449a85a66a625/Service-Guide/images/rabbitmq/rabbitmq_image_13.png)

#### 큐 엔드포인트 테스트

> `curl -XPOST -d 'test' http://test-app.<YOUR-DOMAIN>/queues/<YOUR-QUEUE-NAME>` `curl -XGET http://test-app.<YOUR-DOMAIN>/queues/<YOUR-QUEUE-NAME>` ![](https://github.com/jhuhm13579/trans-test/tree/c3fa60c3f2804eba4cf4bb19f90449a85a66a625/Service-Guide/images/rabbitmq/rabbitmq_image_14.png)
