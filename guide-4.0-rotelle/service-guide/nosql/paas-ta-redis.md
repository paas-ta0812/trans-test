...
1. [문서 개요](paas-ta-redis.md#1)
   * [1.1. 목적](paas-ta-redis.md#11)
   * [1.2. 범위](paas-ta-redis.md#12)
   * [1.3. 시스템 구성도](paas-ta-redis.md#13)
   * [1.4. 참고자료](paas-ta-redis.md#14)
2. [Redis 서비스팩 설치](paas-ta-redis.md#2)
   * [2.1. 설치 전 준비 사항](paas-ta-redis.md#21)
   * [2.2. Redis 서비스 릴리즈 업로드](paas-ta-redis.md#22)
   * [2.3. Redis 서비스 Deployment 파일 수정 및 배포](paas-ta-redis.md#23)
   * [2.4. Redis 서비스 브로커 등록](paas-ta-redis.md#24)
3. [Redis 연동 Sample App 설명](paas-ta-redis.md#3)
   * [3.1. Sample App 구조](paas-ta-redis.md#31)
   * [3.2. PaaS-TA에서 서비스 신청](paas-ta-redis.md#32)
   * [3.3. Sample App에 서비스 바인드 신청 및 App 확인](paas-ta-redis.md#33)
4. [Redis Client 툴 접속](paas-ta-redis.md#4)
   * [4.1. Redis Desktop Manager 설치 및 연결](paas-ta-redis.md#41)
...
본 문서의 설치된 시스템 구성도입니다. Redis dedicated-node\(2대\), Redis 서비스 브로커로 최소사항을 구성하였다. ![](https://github.com/jhuhm13579/trans-test/tree/c3fa60c3f2804eba4cf4bb19f90449a85a66a625/Service-Guide/images/redis/redis_image_01.png)
...
> `$ cf push --no-start`
>
> ![](https://github.com/jhuhm13579/trans-test/tree/c3fa60c3f2804eba4cf4bb19f90449a85a66a625/Service-Guide/images/redis/redis_image_06.png)
...
>
> ![](https://github.com/jhuhm13579/trans-test/tree/c3fa60c3f2804eba4cf4bb19f90449a85a66a625/Service-Guide/images/redis/redis_image_09.png)

#### 바인드를 적용하기 위해서 App을 재기동한다.

> `$ cf restart redis-example-app`
>
> ![](https://github.com/jhuhm13579/trans-test/tree/c3fa60c3f2804eba4cf4bb19f90449a85a66a625/Service-Guide/images/redis/redis_image_10.png)
...
>
> ![](https://github.com/jhuhm13579/trans-test/tree/c3fa60c3f2804eba4cf4bb19f90449a85a66a625/Service-Guide/images/redis/redis_image_11.png)

#### Key 값을 이용하여 Redis 에 저장되어 있는 Value 값 Get

> `$curl -X GET $APP/foo`

![](https://github.com/jhuhm13579/trans-test/tree/c3fa60c3f2804eba4cf4bb19f90449a85a66a625/Service-Guide/images/redis/redis_image_12.png)

#### Key 값을 이용하여 Redis 에 저장되어 있는 Value 삭제

> `$ curl -X DELETE $APP/foo`

![](https://github.com/jhuhm13579/trans-test/tree/c3fa60c3f2804eba4cf4bb19f90449a85a66a625/Service-Guide/images/redis/redis_image_13.png)
