# PaaS-TA Logging 서비스 설치 가이드\_v1.0
...
* [1.3. 시스템 구성](paas-ta-logging-_v1.0.md#1.3)
* [1.4. 참고자료](paas-ta-logging-_v1.0.md#1.4)

[2. Logging 서비스 설치](paas-ta-logging-_v1.0.md#2)

* [2.1. 설치 전 준비 사항](paas-ta-logging-_v1.0.md#2.1)
* [2.1.1. Logging 서비스 설치 파일 다운로드](paas-ta-logging-_v1.0.md#2.1.1)
* [2.1.2. Stemcell 다운로드](paas-ta-logging-_v1.0.md#2.1.2)
* [2.2. Logging 서비스 릴리즈 업로드](paas-ta-logging-_v1.0.md#2.2)
* [2.3. Logging 서비스 Deployment 파일 수정 및 배포](paas-ta-logging-_v1.0.md#2.3)

[3. Logging 서비스 관리](paas-ta-logging-_v1.0.md#3)

* [3.1. Logging 서비스 UAA Client 등록](paas-ta-logging-_v1.0.md#3.1)
* [3.2. Logging 서비스 사용 활성화](paas-ta-logging-_v1.0.md#3.2)
...
![](https://github.com/jhuhm13579/trans-test/tree/c3fa60c3f2804eba4cf4bb19f90449a85a66a625/Service-Guide/images/logging_service/image001.png)
...
* 설치 파일 다운로드 위치 : [https://paas-ta.kr/download/package](https://paas-ta.kr/download/package) = Deployment : paasta-logging-service-2.0 = 릴리즈 파일 : paasta-logging-service-release.tgz
...
* PaaS-TA 운영자 포탈에 접속한다. ![](https://github.com/jhuhm13579/trans-test/tree/c3fa60c3f2804eba4cf4bb19f90449a85a66a625/Service-Guide/images/logging_service/image002.png)
