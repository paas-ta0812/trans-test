# 이종\_PaaS-TA\_설치\_자동화\_사용\_가이드\_\[OP\_Azure\]\_v1.0

### Table of Contents

1. [개요](_paas-ta_-_-_-_-_-op_azure-_v1.0.md#1)
   * 1.1 [목적](_paas-ta_-_-_-_-_-op_azure-_v1.0.md#2)
   * 1.2 [범위](_paas-ta_-_-_-_-_-op_azure-_v1.0.md#3)
2. [이종 PaaS-TA 사용 가이드](_paas-ta_-_-_-_-_-op_azure-_v1.0.md#4)
   * 2.1 [플랫폼 관리자 관리](_paas-ta_-_-_-_-_-op_azure-_v1.0.md#5)
   * 2.2 [로그인 계정 관리](_paas-ta_-_-_-_-_-op_azure-_v1.0.md#6)
   * 2.3 [인프라 관리](_paas-ta_-_-_-_-_-op_azure-_v1.0.md#7)
   * 2.4 [스템셀과 릴리즈](_paas-ta_-_-_-_-_-op_azure-_v1.0.md#8)
   * 2.5 [이종 BOOTSTRAP 설치하기](_paas-ta_-_-_-_-_-op_azure-_v1.0.md#9)
     * 2.5.1 [인프라 환경 설정 관리](_paas-ta_-_-_-_-_-op_azure-_v1.0.md#10)
     * 2.5.2 [스템셀 다운로드](_paas-ta_-_-_-_-_-op_azure-_v1.0.md#11)
     * 2.5.3 [릴리즈 다운로드](_paas-ta_-_-_-_-_-op_azure-_v1.0.md#12)
     * 2.5.4 [이종 BOOTSTRAP 설치](_paas-ta_-_-_-_-_-op_azure-_v1.0.md#13)
   * 2.6 [이종 CF-DEPLOYMENT 설치하기](_paas-ta_-_-_-_-_-op_azure-_v1.0.md#14)
     * 2.6.1 [스템셀 업로드](_paas-ta_-_-_-_-_-op_azure-_v1.0.md#15)
     * 2.6.2 [PaaS-TA 릴리즈 사용](_paas-ta_-_-_-_-_-op_azure-_v1.0.md#16)
     * 2.6.3 [이종 CF-DEPLOYMENT 설치](_paas-ta_-_-_-_-_-op_azure-_v1.0.md#17)
...
![](../../../.gitbook/assets/useflow_azure_openstack%20%282%29.png)
...
![](../../../.gitbook/assets/login_account_add%20%283%29.png)
...
![](../../../.gitbook/assets/login_account_modify%20%284%29.png)
...
![](../../../.gitbook/assets/azure_account_info%20%282%29.png)
...
![](../../../.gitbook/assets/azure_account_add%20%282%29.png)
...
![](../../../.gitbook/assets/azure_resource_group_add%20%282%29.png)
...
![](../../../.gitbook/assets/azure_subnet_add%20%282%29.png)
...
2. 정보를 입력 후 “생성” 버튼을 클릭한다.
   ...
   ![](../../../.gitbook/assets/azure_storage_account_create%20%282%29.png)
...
* 아래 화면에서 Private/Blob Access Level의 blob 2개를 생성한다.
  ...
  ![](../../../.gitbook/assets/azure_private_bloc_access_level_blob_2create%20%282%29.png)
...
![](../../../.gitbook/assets/azure_storage_blob_cretate_table%20%282%29.png)
...
![](../../../.gitbook/assets/azure_public_ip_assign%20%282%29.png)
...
![](../../../.gitbook/assets/azure_keypair_create%20%282%29.png)
...
![](../../../.gitbook/assets/azure_security_group_create%20%282%29.png)
...
![](../../../.gitbook/assets/azure_routetable_add%20%282%29.png)
...
![](../../../.gitbook/assets/azure_routetable_associate%20%282%29.png)
...
![](../../../.gitbook/assets/openstack_account_add%20%284%29.png)
...
![](../../../.gitbook/assets/openstack_network_add%20%287%29.png)
...
![](../../../.gitbook/assets/openstack_subnet_add%20%287%29.png)
...
![](../../../.gitbook/assets/openstack_router_add%20%287%29.png)
...
![](../../../.gitbook/assets/openstack_interface_attach%20%284%29.png)
...
![](../../../.gitbook/assets/openstack_gateway_add%20%284%29.png)
...
![](../../../.gitbook/assets/openstack_keypair_add%20%284%29.png)
...
![](../../../.gitbook/assets/openstack_floatingip_add%20%284%29.png)
...
![](../../../.gitbook/assets/openstack_securitygroup_add%20%283%29.png)
...
![](../../../.gitbook/assets/hb_bootstrap_deployflow_azure_openstack%20%282%29.png)
...
![](../../../.gitbook/assets/infra_env_info_azure%20%282%29.png)
...
![](../../../.gitbook/assets/azure_infra_env_add%20%282%29.png)
...
![](../../../.gitbook/assets/openstack_infra_env_add%20%286%29.png)
...
![](../../../.gitbook/assets/stemcell_add%20%2816%29.png)
...
![](../../../.gitbook/assets/bosh_release_add%20%2816%29.png)
...
![](../../../.gitbook/assets/bpm_release_add%20%2815%29.png)
...
![](../../../.gitbook/assets/osconf_release_add%20%283%29.png)
...
![](../../../.gitbook/assets/hb_bootstrap_cpiinfo%20%284%29.png)
...
![](../../../.gitbook/assets/hb_bootstrap_networkinfo%20%283%29.png)
...
![](../../../.gitbook/assets/hb_bootstrap_authinfo%20%284%29.png)
...
![](../../../.gitbook/assets/hb_bootstrap_defaultinfo%20%283%29.png)
...
![](../../../.gitbook/assets/hb_bootstrap_resourceinfo%20%284%29.png)
...
6. 상기 2 ~ 5 항목을 반복 수행하여 Openstack 설치 정보를 등록한다.
   ...
   ![](../../../.gitbook/assets/hb_bootstrap_install%20%284%29.png)
...
![](../../../.gitbook/assets/hb_bootstrap_director_add%20%284%29.png)
...
![](../../../.gitbook/assets/hb_cfdeployment_deployflow_azure_openstack%20%282%29.png)
...
![](../../../.gitbook/assets/hb_cfdeployment_stemcell_upload%20%283%29.png)
...
![](../../../.gitbook/assets/hb_cfdeployment_paasta_release_4.6%20%284%29.png)
...
![](../../../.gitbook/assets/hb_cfdeployment_defaultinfo%20%283%29.png)
...
![](../../../.gitbook/assets/hb_cfdeployment_networkinfo%20%283%29.png)
...
![](../../../.gitbook/assets/hb_cfdeployment_authinfo%20%284%29.png)
...
![](../../../.gitbook/assets/hb_cfdeployment_resourceinfo%20%283%29.png)
...
![](../../../.gitbook/assets/hb_cfdeployment_instanceinfo%20%284%29.png)
...
6. 상기 2 ~ 5 항목을 반복 수행하여 Openstack CF-DEPLOYMENT 설치 정보를 등록한다.
   ...
   ![](../../../.gitbook/assets/hb_cfdeployment_install%20%283%29.png)
...
![](../../../.gitbook/assets/hb_cfdeployment_install_not_pair%20%283%29.png)
